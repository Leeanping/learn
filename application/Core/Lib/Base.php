...

{
            ...
            if (isset ($highlightKeywords)) {
...

                {
                    ...
                    if ($tracn) {
                        ...
                        $kwTra = \Core\Comm\Util::simcn2tracn ($kw); //中文转繁体
                        ...
                        $kwSim = \Core\Comm\Util::simcn2tracn ($kw, false); //繁体转中文
...

    {
        ...
        !isset ($u["timestamp"]) or $u["timestring"] = \Core\Util\Tutil::tTimeFormat ($u["timestamp"]);
        ...
        if (isset ($u["tweet"]) && is_array ($u["tweet"])) {
...

            {
                ...
                $t["text"] = \Core\Lib\Tutil::tContentFormat ($t["text"]);

                $t["timestring"] = \Core\Util\Tutil::tTimeFormat ($t["timestamp"]);
